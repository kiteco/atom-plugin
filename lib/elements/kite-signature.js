...
class KiteSignature extends HTMLElement {
  ...
  detachedCallback() {
    this.listElement.element.removeAttribute('collapse-documentation');
  }
  ...
  setData(data, compact = false) {
    ...
    this.innerHTML = `
    <div class="kite-docs-collapser">
      <a href="">
        <i class="icon-chevron-up"></i>
        <span class="collapse">Collapse docs</span>
        <span class="expand">Expand docs</span>
      </a>
    ...
    this.subscriptions.add(new DisposableEvent(this.querySelector('.kite-docs-collapser'), 'click', (e) => {
      this.listElement.element.hasAttribute('collapse-documentation')
      ? this.listElement.element.removeAttribute('collapse-documentation')
      : this.listElement.element.setAttribute('collapse-documentation', '');
    }));
