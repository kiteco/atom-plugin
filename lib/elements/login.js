  ...
  constructor(classes=[]) {
    ...
    this.element.innerHTML = `
      <form>
        ...
        <div>
          <button type="submit" class="submit btn btn-primary inline-block  has-password">Sign in to Kite</button>
          <button type="button" class="reset-password btn inline-block  has-password">Reset Password</button>
