...
module.exports = class Status {
    ...
    if (this.editors.hasActiveSupportedFile()) {
      ...
      this.pollPromise = KiteAPI.requestJSON({
        ...
        .then(o => {
          ...
          if (o.status === 'initializing') {
            this.element.setAttribute('is-initializing', '');
            this.tooltipText = TOOLTIPS.initializing;
          } else if (o.status === 'indexing') {
  ...
  _removeStatusAttributes() {
    ...
    this.element.removeAttribute('is-initializing');
