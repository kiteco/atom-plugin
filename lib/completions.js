  ...
  getSuggestions(params) {
    ...
    return editors.isGrammarSupported(params.editor)
      ? delayPromise(() => {
        ...
        return promise.then(() =>
          DataLoader.getSnippetCompletionsAtPosition(params.editor, params.editor.getCursorBufferPosition()));
        // .then(suggestions =>
        ...
        // .then(suggestions => {
        //   suggestions.forEach(s => {
        //     s.replacementPrefix = params.editor.getTextInRange(s.replace);
        //   });
        //   return suggestions;
        // });
      }, 0)
